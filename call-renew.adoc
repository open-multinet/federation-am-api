...
Options include :best_effort, specifying whether the client prefers all included slivers to be renewed or none, or wants a partial success if possible. See the Common Concepts page under :best_effort and Operations on Individual Slivers.
