...
////////////////////////////////////
refer to this using:   A struct containting optional arguments, indexed by name. See <<OptionsArgument,General Options Argument Section>>.
////////////////////////////////////
...
[source]
   [
      {
        ":type" : "<type name, case insensitive>",
        ":version" : "<type version (string containing an integer)>",
...
/////////////////////////////////////
refer to this using:   See the <<CommonOptionEndTime, +:end_time+>> for details.
/////////////////////////////////////

***********************************
[horizontal]
Name:: +:end_time+ option (<<Allocate>>, <<Provision>>
Name:: +expiration_time+ argument (<<Renew>>)
Calls:: <<Allocate>>, <<Provision>>, <<Renew>>
Supported by the server:: Mandatory
Included by client:: Optional for <<Allocate>>, <<Provision>>, Required for <<Renew>>
XmlRpc type:: +string+
String content type::  RFC 3339 date
***********************************
...
*TODO: this is a very common return. Each call has only minor differences. It should be described in general instead of at each call.
